...
barplot(RodnostSLO[145:156, 3], names.arg=RodnostSLO[145:156, 2],las=2, ylab="št.živorojenih otrok", main="Rodnost v SLO po regijah za leto 2013",col="lightblue", cex.names=0.45)
